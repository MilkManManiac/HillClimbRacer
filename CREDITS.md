...
## CC0 (public domain — no attribution required, listed for reference)
- Pine trees — Quaternius (Poly Pizza)
- Car body "Sedan" — Kenney Car Kit (kenney.nl)
- Rocks — Quaternius (Poly Pizza)

## CC-BY 4.0 / 3.0 (attribution required)
- "Roadsign" by Mathias Søllested — CC-BY (via Poly Pizza)
